...
public class Helicoptero implements Aeronave {
    ...
    public Helicoptero(int velocidad, int cargaPersonas, ArrayList<String> armamento, ArrayList<String> provisiones) {
    ...
    //Funciones implementadas por la interface vehiculo
    @Override
